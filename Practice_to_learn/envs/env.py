...
class VVCEnv:
    def __init__(self,
        ...
        self.len_total = self.len_offline + self.len_online  # len_total = 27649
    ...
    def step(self, action=None):
        ...
        if action is None:
            ...
            # set load | multiplying ami data * nominal load
        ...
        if self.global_time == self.len_total:  # it seems the whole time process take 27649
            done = True
            self.global_time = None
        else:
            done = False
